...
def _get_dataset_params_from_dataset_definitions(dataset_definitions, dataset_name):
    print("!!!starting _get_dataset_params_from_dataset_definitions inside")
    ...
    print(f"!!!cur_dataset_definition: {cur_dataset_definition}")
...
def _create_anomaly_classification_dataset_and_labels_schema(dataset_params):
    ...
    dataset = OteMvtecDataset(path=dataset_params.dataset_path, seed=0).generate()
...
class TestOTEReallifeAnomalyDetection(OTETrainingTestInterface):
    ...
    def params_factories_for_test_actions_fx(self, current_test_parameters_fx,
        ...
        def _training_params_factory() -> Dict:
            print(f"!!!_training_params_factory started")
            ...
            print("!!!Starting _get_dataset_params_from_dataset_definitions")
            print(f"!!!dataset_definitions: {dataset_definitions}, dataset_name: {dataset_name}")
        ...
        training_params = _training_params_factory()
    ...
    def data_collector_fx(self, request) -> DataCollector:
        print("!!!Fixture data_collector_fx started")
    ...
    def test(self,
        ...
        print(f"test_parameters: {test_parameters},  data_collector_fx: {data_collector_fx}, test_case_fx: {test_case_fx}, cur_test_expected_metrics_callback_fx: {cur_test_expected_metrics_callback_fx}")
